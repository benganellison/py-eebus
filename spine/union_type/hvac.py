...
@spine_type('ns_p:HvacOverrunStatusType', is_value_type=True, no_attrib_name=False)
...
@spine_type('ns_p:HvacOverrunTypeType', is_value_type=True, no_attrib_name=False)
...
@spine_type('ns_p:HvacOperationModeTypeType', is_value_type=True, no_attrib_name=False)
...
@spine_type('ns_p:HvacSystemFunctionTypeType', is_value_type=True, no_attrib_name=False)
